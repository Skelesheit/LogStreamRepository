...
while True:
    ...
    if not game_over:
        for row in range(3):
            for col in range(3):
                ...
                if color == green:
                    pygame.draw.rect(screen, pink, (x, y, size_block, size_block))
                else:
    ...
    if game_over:
        ...
        text = font.render(f'Победил: {game_over}', True, white)
...
# поменял цвета местами для игроков.
# Теперь круги с зелёным цветом, кресики - с красным
